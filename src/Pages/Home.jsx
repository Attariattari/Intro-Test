...
export default function Home() {
  ...
  useEffect(() => {
    if (!state.data || !state.currentCategory) return;
  ...
  }, [state.currentCategory, state.data]); // ✅ Runs when category or data changes
  ...
  const getCategorySlides = () => {
          ...
          >
            <div
              onClick={() => {
                ...
                // Navigate with MainCategoryName and MainCategoryId
            ...
            <div className="flex w-full h-full overflow-x-auto">
              {state.selectedProducts.map((product, index) => (
                ...
                >
                  ...
                  />
                  {/* 🟢 NEW Tag shows only on the right-side image */}
                  ...
                  {/* 🟢 NEW Tag for Mobile (if only one image is shown) */}
                ...
                {groupedProducts.map((product, index) => (
                  <img
                    ...
                    style={{
                      ...
                      height: "100%", // Equal width for each product
                      flexShrink: 0,
                      objectFit: "cover",
                    }}
                  />
    ...
    // 🟢 Combine Multi-Product Slides First, then Single-Product Slides
